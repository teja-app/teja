...
extension HabitLogByIndex on IsarCollection<HabitLog> {
  ...
  HabitLog? getByIdSync(String id) {
  ...
  Future<List<HabitLog?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<HabitLog?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(HabitLog object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(HabitLog object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<HabitLog> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<HabitLog> objects, {bool saveLinks = true}) {
    return putAllByIndexSync(r'id', objects, saveLinks: saveLinks);
  }
}

extension HabitLogQueryWhereSort on QueryBuilder<HabitLog, HabitLog, QWhere> {
  QueryBuilder<HabitLog, HabitLog, QAfterWhere> anyIsarId() {
...
extension HabitLogQueryWhere on QueryBuilder<HabitLog, HabitLog, QWhereClause> {
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> isarIdEqualTo(Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> isarIdLessThan(Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> idEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterWhereClause> idNotEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension HabitLogQueryFilter
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idEqualTo(
    String value, {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: '',
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'id',
        value: '',
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> isarIdEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> isarIdGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> isarIdLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> isarIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitLogQuerySortThenBy
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitLogQueryWhereDistinct
  ...
  QueryBuilder<HabitLog, HabitLog, QDistinct> distinctById(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension HabitLogQueryProperty
  ...
  QueryBuilder<HabitLog, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
